...
export const cities: City[] = [
  ...
  },
  {
    ...
    usesIntro: 'From the freight yards around Rickenbacker to the grain country of Madison and Union counties, here\'s how central Ohio puts a container to work.',
    cta: {

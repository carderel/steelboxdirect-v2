...
*The door stencil up close: owner code, serial number, boxed check digit, and the size/type code on the line below. It's the same ISO 6346 layout on every standardized container.*
